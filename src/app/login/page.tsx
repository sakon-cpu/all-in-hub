    ...
    return (
        <div className="glass border-white/5 p-12 rounded-3xl shadow-2xl">
            <div className="flex flex-col items-center mb-10 text-center">
                <div className="w-20 h-20 rounded-2xl bg-accent/10 flex items-center justify-center border border-accent/20 mb-6 group transition-all duration-500 hover:border-accent">
            ...
            <p className="mt-10 text-[9px] text-gray-600 uppercase tracking-widest text-center">
                {t.auth.hint}
            </p>
        </div>
    );
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-red-900/10 rounded-full blur-[120px] animate-pulse" />
            </div>
            ...
            >
                <Suspense fallback={
                    <div className="glass border-white/5 p-12 rounded-3xl shadow-2xl flex items-center justify-center min-h-[400px]">
